const fetchDemoEvents = async () => {
    ...
    const events = [

        {
            ...
            description:
            "Hands-on AI and ML workshop for students and developers",
...

        {
            ...
            description:
            "Startup founders and entrepreneurs networking event",
...

        {
            ...
            description:
            "Developers meetup and coding discussion",
...

        {
            ...
            description:
            "Security experts explain cyber threats and protection methods",
...

        {
            ...
            description:
            "AWS and Cloud fundamentals training session",
...

        {
            ...
            description:
            "Data analytics and machine learning discussion",
...

        {
            ...
            description:
            "Full stack development training for beginners",
...

        {
            ...
            description:
            "24 hour coding challenge for developers",
...

        {
            ...
            description:
            "Introduction to blockchain and Web3 technologies",
...

        {
            ...
            description:
            "Conference focused on women developers and leaders",
